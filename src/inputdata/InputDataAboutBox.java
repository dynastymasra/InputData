...
public class InputDataAboutBox extends javax.swing.JDialog {

    public InputDataAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(inputdata.InputDataApp.class).getContext().getResourceMap(InputDataAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(inputdata.InputDataApp.class).getContext().getActionMap(InputDataAboutBox.class, this);
